...
export const themes=[
 ...
 {id:'cs1',title:'Main countersubject',location:'Bass, bars 3–4',text:'The main countersubject begins with ascending crotchets and a leap down and back. It supplies the imitative passage in bars 12–16 and returns in the final group. Adapted statements are marked CS*.'},
 {id:'cs2',title:'Countersubject x',location:'Tenor, bars 16–17',text:'The leap up is followed by suspensions and descending chromatic motion. This line returns in the alto and soprano, with changes at its opening. Tovey identifies it as an additional countersubject.'},
 {id:'cs3',title:'Countersubject y',location:'Bass, bars 16–17',text:'The slower line ascends through C♯–D–D♯–E, against x. It returns in the tenor and alto. The subject and countersubjects x and y form triple counterpoint in bars 16–21, with adapted returns.'},
];
export const sections=[
 {start:1,end:9,label:'Exposition and codetta',entries:'Bass 1:1 · tenor 2:3 · alto 4:1 · soprano 5:3',detail:'Subject and real answer alternate at intervals of one and a half bars. The main countersubject appears in the bass at bar 3, tenor at bar 4 beat 3 and alto at bar 6. The codetta reaches B major at bar 9.'},
 {start:9,end:16,label:'Paired stretto and episode',entries:'Alto 9:2 → tenor 9:3 · bass 10:3 → soprano 11:1',detail:'The alto’s first note is shortened: its sounding onset precedes the tenor by one minim, within the underlying half-bar scheme. The second pair enters half a bar apart. The figure derived from the main countersubject (c) passes through soprano, alto, bass and tenor in bars 12–15, closing in C♯ minor at bar 16.'},
 {start:16,end:23,label:'Stretto and triple counterpoint',entries:'Alto 16:1 → soprano 17:1 · bass 19:1 → tenor 20:1',detail:'Both pairs enter one bar apart. The subject and countersubjects x and y form triple counterpoint. Their successive dispositions (subject/x/y) are alto/tenor/bass, soprano/alto/tenor and bass/soprano/alto, with adaptations to the recurring material. The final tenor entry adapts the subject to F♯ minor and delays its closing note; the cadence arrives at bar 23.'},

...
for mode,suffix in [('open','annotated'),('keyboard','keyboard')]:
 ...
 for page,batch in enumerate(batches):
  ...
  if page==0:
   ...
   legend=[(left,'S subject / A tonal answer','#244f91'),(left+190,'CS countersubject','#a45112'),(left+340,'Derived figures','#637878')]
   ...
   c.drawString(left,H-82,'* variant / fragment; > continuation; c arpeggio; r rising upbeat; q descending quavers; h subject head')
   y=H-98
  else:y=H-28

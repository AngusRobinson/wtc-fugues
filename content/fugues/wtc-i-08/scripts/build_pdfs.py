...
for mode,suffix in [('open','annotated'),('keyboard','keyboard')]:
 ...
 for page,batch in enumerate(batches):
  ...
  if page==0:
   ...
   legend=[(left,'S subject / A tonal answer','#244f91'),(left+190,'Augmentation / partial augmentation','#843d7c'),(left+405,'Fragments','#637878')]
   ...
   c.drawString(left,H-82,'i inversion; * altered / incomplete; > continuation; S x2 augmentation; S· partial augmentation; h head; t tail')
   y=H-98
  else:y=H-28

...
for mode,suffix in [('open','annotated'),('keyboard','keyboard')]:
 ...
 for page,batch in enumerate(batches):
  ...
  if page==0:
   ...
   legend=[(left,'S subject / A real answer','#244f91'),(left+230,'h / e / d derived figures','#637878')]
   ...
   c.drawString(left,H-82,'* fragment / development; > continuation; h demisemiquaver head; e episode figure; d dotted tail')
   y=H-98
  else:y=H-28

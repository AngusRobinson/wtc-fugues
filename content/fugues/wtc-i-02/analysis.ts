...
export const tonalEvents=[
 {id:'g5',bar:5,q:16,key:'G minor',short:'Gm',roman:'v',type:'cadence',evidence:'The answer closes on B♭ over G. F♯ in the alto resolves to G, establishing the dominant minor key.'},
 {id:'c7',bar:7,q:24.5,key:'C minor',short:'Cm',roman:'i',type:'arrival',evidence:'The bass enters on C under E♭ in the soprano and C in the alto. The C minor return follows the sequential link; the opening quaver of the bar still carries F from bar 6.'},
 {id:'eb11',bar:11,q:40,key:'E♭ major',short:'E♭',roman:'III',type:'arrival',evidence:'The B♭ dominant in bar 10 leads to E♭ in the bass with G and E♭ above. The soprano subject begins half a beat after this arrival.'},
 {id:'eb13',bar:13,q:48,key:'E♭ major',short:'E♭',roman:'III',type:'cadence',evidence:'D in the bass resolves to E♭ under B♭ and G. The entry ends and the next episode begins within this bar.'},
 {id:'g15',bar:15,q:56.5,key:'G minor',short:'Gm',roman:'v',type:'entry',evidence:'The alto begins the answer form on G. C minor harmony persists at the opening; the entry is confirmed in G minor at the cadence in bar 17.'},
 {id:'g17',bar:17,q:64,key:'G minor',short:'Gm',roman:'v',type:'cadence',evidence:'The D dominant with F♯ resolves to G–B♭–G. The new episode begins after this cadence.'},
 {id:'c20',bar:20,q:76,key:'C minor',short:'Cm',roman:'i',type:'arrival',evidence:'B♮ in the approach resolves to C above E♭ in the bass: the tonic returns in first inversion. The soprano entry follows on the second quaver.'},
 {id:'c22',bar:22,q:84,key:'C minor',short:'Cm',roman:'i',type:'cadence',evidence:'G–B–F in bar 21 resolves to C–C–E♭. The following sequence passes through F minor, B♭ and E♭ harmonies before returning to the dominant of C; these are not separate structural key sections.'},
 {id:'c29',bar:29,q:114,key:'C minor',short:'Cm',roman:'i',type:'cadence',evidence:'The dominant at beat 2 resolves to C at beat 3. The doubled bass C is tied through the final bar; the subject enters half a beat later.'},
 {id:'C31',bar:31,q:122,key:'C major',short:'C',roman:'I',type:'close',evidence:'The subject’s final E is natural. The resulting C–E–G sonority is the major closing chord, rather than a preceding modulation to C major.'},
];

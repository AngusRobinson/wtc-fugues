...
for mode,suffix in [('open','annotated'),('keyboard','keyboard')]:
 ...
 for page,batch in enumerate(batches):
  ...
  if page==0:
   ...
   legend=[(left,'S subject / A real answer','#244f91'),(left+190,'CS countersubject','#a45112'),(left+340,'Derived figures','#637878')]
   ...
   c.drawString(left,H-82,'i inversion; * altered / incomplete; > continuation; c falling semiquavers; d returning-note figure; h head')
   y=H-98
  else:y=H-28

...
for mode,suffix in [('open','annotated'),('keyboard','keyboard')]:
 ...
 for page,batch in enumerate(batches):
  ...
  if page==0:
   ...
   legend=[(left,'S subject / A tonal answer','#244f91'),(left+170,'CS1','#a45112'),(left+235,'CS2','#843d7c'),(left+300,'Derived figures','#637878')]
   ...
   c.drawString(left,H-82,'* variant / fragment; > continuation; d rolling thirds; di inversion; e dialogue; h subject head')
   y=H-98
  else:y=H-28
